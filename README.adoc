...
[caption="Maven Central",link=http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.appng%22%20AND%20a%3A%22appng-api%22]
image::https://img.shields.io/maven-central/v/org.appng/appng-api.svg?style=flat-square[]
