...
Check that Java 1.8 is available in your class path:
----
$ java -version
...
=== Download and run the appNG application version
If you run appNG in production you should use the application version.
Download the latest stable release from 
https://appng.org/appng/builds/stable/appng-application-{stable}.war
Extract the content to the ROOT directory of your tomcat8 by using unzip. For 
futher documentation of installing AppNG go to
https://github.com/appNG/appng/tree/master/appng-application/src/main/webapp
