...
In `appNG.properties`, you can use the system's environment variables with the syntax `${sys.<variable>}`. Additionally, also system properties can be used with the syntax `${env.<variable>}`.
