...
* `webservice` +
An  implementation of `org.appng.api.Webservice`
* `soap` +
An  implementation of `org.appng.api.SoapService`
* `rest` +
Any class implementing a  `org.springframework.web.bind.annotation.RestController` including call to the https://appng.org/appng/docs/{project-version}/reference/html/developerguide.html#openapi[appNG OpenAPI^]
