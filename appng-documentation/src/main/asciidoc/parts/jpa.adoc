...
Your repository then offers theses methods, defined by http://docs.spring.io/spring-data/commons/docs/current/api/org/springframework/data/repository/history/RevisionRepository.html[org.springframework.data.repository.history.RevisionRepository^]
